...
#Working directory
WDIR=$PWD 
mkdir -p $WDIR/NATBOT/ModIII_L$LAMB.k$NCRO.s$AVEs.h$AVEh.N$NIND.Vs$Vs
DIR="NATBOT/ModIII_L$LAMB.k$NCRO.s$AVEs.h$AVEh.N$NIND.Vs$Vs"
